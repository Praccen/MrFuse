class MovementSystem extends System {
    ...
    update(dt) {
        for (const e of this.entities) {
            ...
            movComp.velocity.xy.add(new Vec2(movComp.accelerationDirection.xy.x *
                movComp.maxAcceleration.xy.x, movComp.accelerationDirection.xy.y *
                movComp.maxAcceleration.xy.y).multiply(dt));
