class Input {
	...
	texturesRequestedVsLoaded: object;
	camera: Camera;
	audioPlayer: AudioPlayer;
	keys: boolean[];
	drawHud: boolean;
	anyPressed: boolean;
	lastAnyPressed: boolean;
	playAllAudio: boolean;
	// hudObjects: GameObject[];

	constructor(gl: WebGL2RenderingContext, camera: Camera, audioPlayer: AudioPlayer, texturesRequestedVsLoaded: object) {
		this.gl = gl;
		this.camera = camera;
